---
layout: post
title: "JavaScript API 개념 정리 | HTTP와 비동기 통신 흐름"
description: "API 요청이 HTTP를 거쳐 비동기로 처리되는 전체 과정을 처음 보는 사람도 따라갈 수 있도록 설명합니다."
...
image:
  ...
  alt: "JavaScript API 개념 정리 | HTTP와 비동기 통신 흐름"
---
